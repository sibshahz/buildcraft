...
export const CTASection = () => {
  return (
    <section className="py-24 md:py-48 bg-pearl relative overflow-hidden flex items-center justify-center">
      <div className="absolute inset-x-0 bottom-0 h-1/2 bg-royal z-0" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full">
        <motion.div
          ...
          className="bg-royal p-10 md:p-24 shadow-[0_50px_100px_-20px_rgba(26,22,8,0.4)] overflow-hidden relative"
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-20 relative z-10">
            <div className="max-w-xl">
              ...
              <div className="flex flex-col sm:flex-row items-center space-y-6 sm:space-y-0 sm:space-x-10">
                <Link
                  href="/contact"
                  className="group relative bg-gold text-royal px-12 py-6 w-full sm:w-auto text-center font-bold uppercase tracking-[0.3em] text-[11px] transition-all duration-500 hover:bg-sand"
                >
            ...
            <div className="grid grid-cols-1 gap-8">
              <div className="bg-white/5 border border-white/10 p-10 backdrop-blur-md group hover:bg-white transition-all duration-500 cursor-pointer">
                <div className="flex items-center space-x-8">
                  <div className="w-16 h-16 bg-gold/10 group-hover:bg-gold flex items-center justify-center transition-colors">
                    <Phone className="w-6 h-6 text-gold group-hover:text-royal" />
                  </div>
                  <div className="flex flex-col">
                    <span className="text-[10px] uppercase font-bold text-sand/40 group-hover:text-royal/40 tracking-[0.3em] mb-2">
                      Concierge Call
                    </span>
                    <span className="text-2xl font-serif text-sand group-hover:text-royal transition-colors">
                      +971 56 496 1186
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-10 backdrop-blur-md group hover:bg-white transition-all duration-500 cursor-pointer">
                <div className="flex items-center space-x-8">
                  <div className="w-16 h-16 bg-gold/10 group-hover:bg-gold flex items-center justify-center transition-colors">
                    <Mail className="w-6 h-6 text-gold group-hover:text-royal" />
                  </div>
                  <div className="flex flex-col">
                    <span className="text-[10px] uppercase font-bold text-sand/40 group-hover:text-royal/40 tracking-[0.3em] mb-2">
                      Electronic Liaison
                    </span>
                    <span className="text-xl font-serif text-sand group-hover:text-royal transition-colors break-all">
